...
angular.module('quizApp',['ui.router',"checklist-model",'ngMaterial','app.home','app.contact','app.signin','app.signup','app.dash'
,'app.about','app.getQuestion',"app.addQuestion",'app.userprofile','app.historic','app.ourActivities','app.bureau'])
